...
func (m *FeedRequest) GetEnd() uint64 {
	if m != nil {
		return m.End
	}
	return 0
...
var fileDescriptor_296dc607c23b8aea = []byte{
	...
	0x42, 0xc9, 0x94, 0x8b, 0x1b, 0xa4, 0x3e, 0x28, 0xb5, 0xb0, 0x34, 0xb5, 0xb8, 0x44, 0x48, 0x84,
	0x8b, 0xb5, 0xb8, 0x24, 0xb1, 0xa8, 0x04, 0x6a, 0x17, 0x84, 0x23, 0x24, 0xc0, 0xc5, 0x9c, 0x9a,
	0x07, 0xb1, 0x8a, 0x25, 0x08, 0xc4, 0x34, 0xb2, 0xe4, 0xe2, 0x0d, 0x06, 0xbb, 0x3a, 0x18, 0xe2,
	0x68, 0x21, 0x0d, 0x2e, 0x16, 0x90, 0x39, 0x42, 0xfc, 0x20, 0x2b, 0x90, 0x4c, 0x94, 0xe2, 0x85,
	0x09, 0x80, 0xed, 0x35, 0x60, 0x74, 0x92, 0x38, 0xf1, 0x48, 0x8e, 0xf1, 0xc2, 0x23, 0x39, 0xc6,
	0x07, 0x8f, 0xe4, 0x18, 0x27, 0x3c, 0x96, 0x63, 0xb8, 0xf0, 0x58, 0x8e, 0xe1, 0xc6, 0x63, 0x39,
	0x86, 0x24, 0x36, 0xb0, 0xcf, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x27, 0xa5, 0xa7, 0x7d,
	0x11, 0x01, 0x00, 0x00,
}
...
func (m *FeedRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.End != 0 {
		i = encodeVarintStreamService(dAtA, i, uint64(m.End))
		i--
		dAtA[i] = 0x10
	}
	if m.Start != 0 {
...
func (m *FeedRequest) Size() (n int) {
	...
	if m.End != 0 {
		n += 1 + sovStreamService(uint64(m.End))
	}
	return n
}
